...
if(!class_exists('Edge_Plus_Features') && !class_exists('Alternative_Customize_upgrade')){
	class Edge_Customize_upgrade extends WP_Customize_Control {
		public function render_content() { ?>
			...
			<a href="<?php echo esc_url( 'https://tickets.themefreesia.com' ); ?>" title="<?php esc_html_e( 'Support Ticket', 'edge' ); ?>" target="_blank" id="about_edge">
...
if(!class_exists('Edge_Plus_Features')){
	if(!function_exists('alternative_customize_register')){
